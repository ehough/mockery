...
class ehough_mockery_mockery_Recorder
{
     ...
     * a ehough_mockery_Mockery::mock() call in the same way as a partial mock requires.
     *
     * @param ehough_mockery_mockery_MockInterface $mock
     * @param object $subject
     * @return void
     */
    public function __construct(ehough_mockery_mockery_MockInterface $mock, $subject)
    {
        $this->_mock = $mock;
