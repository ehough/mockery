...
class ehough_mockery_mockery_Expectation
{
     ...
     * @var string
     */
    protected $_countValidatorClass = 'ehough_mockery_mockery_countvalidator_Exact';
     ...
     * @param string $name
     */
    public function __construct(ehough_mockery_mockery_MockInterface $mock, $name)
    {
        $this->_mock = $mock;
        $this->_name = $name;
    }
    ...
    {
        $this->andReturn(new ehough_mockery_mockery_Undefined);
        return $this;
    }
    ...
    public function times($limit = null)
    {
        ...
        $this->_countValidatorClass = 'ehough_mockery_mockery_countvalidator_Exact';
        return $this;
    }
    ...
    {
        $this->_countValidatorClass = 'ehough_mockery_mockery_countvalidator_AtLeast';
        return $this;
    }
    ...
    {
        $this->_countValidatorClass = 'ehough_mockery_mockery_countvalidator_AtMost';
        return $this;
    }
    ...
    {
        if ($this->_mock instanceof ehough_mockery_mockery_Mock) {
