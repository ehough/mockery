...
class ehough_mockery_mockery_CompositeExpectation
{
     ...
     *
     * @param ehough_mockery_mockery_Expectation| ehough_mockery_mockery_CompositeExpectation $expectation
     * @return void
     */
    ...
    /**
     * ehough_mockery_Mockery API alias to getMock
     *
     * @return ehough_mockery_mockery_MockInterface
     */
